...
import { Card, Cta, PageHero, Reveal, Section, SectionHeading } from "@/components/site-ui";
...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Built by students. Driven by impact." },
    ],
  }),
  component: About,
});
...
const values = [
  { t: "Impact", b: "We measure ourselves by what changes for organizations, not by what we ship." },
  { t: "Ownership", b: "Everything we build belongs to the organization it was built for." },
  { t: "Collaboration", b: "We work with organizations, not for them at a distance." },
  { t: "Accessibility", b: "Built for real users on real devices and real connections." },
  { t: "Integrity", b: "We don't overstate results or claim work we haven't done." },
  { t: "Learning", b: "Every project makes our students better at their craft." },
];
      ...
      <Section id="story">
        <div className="grid gap-14 lg:grid-cols-2 lg:items-center">
          <Reveal>
            <SectionHeading
              eyebrow="Our Story"
              title="It started with a mismatch."
              intro="Students were building skills in engineering, design and communication with nowhere meaningful to apply them. Ethiopian nonprofits were doing essential work with digital presences that didn't reflect it. Link4Good exists to put those two things together."
            />
          </Reveal>
          <Reveal delay={100}>
            <img
          ...
          {[0, 1, 2, 3].map((i) => (
            <Reveal key={i} delay={i * 70}>
              <div className="h-full rounded-xl border border-dashed border-border bg-background p-6">
                ...
                <p className="mt-4 text-xs text-muted-foreground">Profile coming soon</p>
              </div>
            </Reveal>
          ))}
        </div>
